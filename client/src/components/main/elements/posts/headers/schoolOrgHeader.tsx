...
const getRoleString = (postedBy: User): string | null => {
    if (postedBy.userType === 'eBoard') {
        return (postedBy as Eboard).title;
...
const SchoolHeader: React.FC<SchoolHeaderProps> = ({ postedBy, datePosted, postType, display, isQuestion }) => {
