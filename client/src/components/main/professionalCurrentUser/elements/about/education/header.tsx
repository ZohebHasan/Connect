        ...
        <EducationHeader>
            <Wrapper>
                    ...
                    <Icon2Container>
                        <BorderContainer>
                            <BorderImageContainer>
                                <BorderIcon src={isDarkMode ? EducationLight : EducationDark} />
                            </BorderImageContainer>
                            <TopImageContainer>
                                <Icon src={isDarkMode ? EducationDark : EducationLight} />
                            </TopImageContainer>
                        </BorderContainer>
                    </Icon2Container>
                    <Icon1Container>
                ...
                <TextContainer>
                    ...
                    {/* <LeftToRightText size={"2rem"}>Education</LeftToRightText> */}
