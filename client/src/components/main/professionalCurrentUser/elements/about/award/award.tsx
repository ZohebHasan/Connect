        ...
        <Award>
          ...
          <Musk>
            ...
            <RoleContainer>
              <RoleWrapper>
                <StringIconContainer>
                  <AwardIcon src={isDarkMode ? AwardIconDark : AwardIconLight} />
                  <VerticalLine />
                </StringIconContainer>
                <Role>
                  <RoleTop>
                  ...
                  <RoleDescription>
                    ...
                    <Text variant={"transparent"} size={"0.9rem"} fontWeight={"300"}>
                      Got an Award for being an idiot and
