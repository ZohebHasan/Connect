...
const ResearchElement: React.FC = () => {
  ...
  return (
    <ResearchContainer>
      <Header HeaderType='research'/>
      <Researchs>
        <DegreeWrapper>
          <StringIconContainer>
            <JobIcon src={isDarkMode ? ResearchDark : ResearchLight} />
            <VerticalLine />
          </StringIconContainer>
          ...
          <Degree>
            ...
            <ResearchLinkContainer>
              <ResearchLinkWrapper $isDarkMode={isDarkMode}>
                <Text variant={"normal"} size={"0.9rem"} fontWeight={"300"}>
...
const ResearchLinkWrapper = styled.div<{ $isDarkMode: boolean }>`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: flex-start;
...
const ResearchLinkList = styled.div`
  display: flex;
  flex-direction: row;
`

const ResearchLinkContainer = styled.div`
  display: flex;
  align-items: center;
  justify-content: flex-start;
  margin-top: 1rem;
