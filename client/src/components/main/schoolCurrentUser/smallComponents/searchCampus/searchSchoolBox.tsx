...
interface SearchCampusInputProps {
  id: string;
  label: string;
  width?: string;
  value: string;
...
const SearchCampusInput: React.FC<SearchCampusInputProps> = ({ id, label, value, onChange, width, isSearchBox }) => {
...
export default SearchCampusInput;
